...
<h1 className='text-[28px] md:text-[31.68px]] lg:text-[40px] xl:text-6xl font-semibold tracking-[4px] xl:tracking-[10px] tracking-in-expand'>PROJECTS .</h1>
</div>
...
<h1 className='uppercase text-purple text-[22px] md:text-[42px] lg:text-[44px] md:pt-10 font-medium tracking-[2px] leading-[1.1] tracking-in-expand'>Get a glimpse into my world.</h1>
...
<div className='lg:max-w-[40%] '>
    ...
    <p className='uppercase text-purple text-[32px] md:text-[42px]  font-medium tracking-[4px] md:tracking-[6px] leading-[1.1] tracking-in-expand'>
  {data.title}
   </p>
